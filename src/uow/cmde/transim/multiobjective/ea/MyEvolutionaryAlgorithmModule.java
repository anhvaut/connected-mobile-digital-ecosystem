...
/**
 * The {@link MyMyEvolutionaryAlgorithmModule} configures the
 * {@link MyEvolutionaryAlgorithm}.
 * 
 * @author lukasiewycz
 * 
 */
...
public class MyEvolutionaryAlgorithmModule extends OptimizerModule {
	...
	@Constant(value = "alpha", namespace = MyEvolutionaryAlgorithm.class)
	@Info("The size of the population.")
	@Order(1)
	protected int alpha = 100;

	@Constant(value = "mu", namespace = MyEvolutionaryAlgorithm.class)
	@Info("The number of parents per generation.")
	@Order(2)
	protected int mu = 25;

	@Constant(value = "lambda", namespace = MyEvolutionaryAlgorithm.class)
	...
	public void config() {
		...
		bindOptimizer(MyEvolutionaryAlgorithm.class);
