...
package uow.cmde.transim.multiobjective.rs;
...
/**
 * The {@link MyRandomSearch} simply generates random {@link Individual}s and
 * evaluates them.
 * 
 * @author lukasiewycz
 * 
 */
public class MyRandomSearch extends AbstractOptimizer {

	protected final int batchsize;
	private final IndividualFactory individualFactory;

	/**
	 * Constructs a {@link MyRandomSearch}.
	 * 
	 * @param population
	 *            the population
	 * @param archive
	 ...
	 */
	@Inject
	public MyRandomSearch(Population population, Archive archive, IndividualFactory individualFactory,
			IndividualCompleter completer, Control control, Iteration iteration,
			@Constant(value = "batchsize", namespace = MyRandomSearch.class) int batchsize) {
