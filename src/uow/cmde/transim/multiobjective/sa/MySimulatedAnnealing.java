...
package uow.cmde.transim.multiobjective.sa;
...
/**
 * The {@link MySimulatedAnnealing} is a standard implementation of the
 ...
 * 
 */
public class MySimulatedAnnealing extends AbstractOptimizer {
	...
	/**
	 * Constructs a new {@link MySimulatedAnnealing}.
	 * 
	 * @param population
	 *            the population
	 * @param archive
	 ...
	 */
	@Inject
	public MySimulatedAnnealing(Population population, Archive archive, IndividualFactory individualFactory,
