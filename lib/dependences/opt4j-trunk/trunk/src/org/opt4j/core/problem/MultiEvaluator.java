...
public class MultiEvaluator implements Evaluator {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.opt4j.core.problem.Evaluator#evaluate(org.opt4j.core.Phenotype, org.opt4j.core.Objectives)
	 */
	@Override
	public void evaluate(Phenotype phenotype, Objectives objectives) {
		for (Evaluator<Phenotype> evaluator : evaluators) {
			evaluator.evaluate(phenotype, objectives);
		}
	}
