 ...
 * <p>
 * <p>
 * The {@link org.opt4j.core.optimizer.Optimizer} represents an optimization algorithm. Usually all
 * {@link org.opt4j.core.optimizer.Optimizer}s are derived from the {@link org.opt4j.core.optimizer.AbstractOptimizer}
 * that already implements some essential methods (see below).
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * The {@link org.opt4j.core.optimizer.AbstractOptimizer} interacts with the
 * {@link org.opt4j.core.optimizer.OptimizerIterationListener}s, the
 ...
 * as with the {@link org.opt4j.core.optimizer.IndividualCompleter}.
 * </p>
 */
