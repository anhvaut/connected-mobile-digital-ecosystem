...
/**
 * <p>
 * Provides classes for using a PB sovler as {@link org.opt4j.core.problem.Decoder}.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * This package includes a specialized {@link org.opt4j.core.problem.Decoder} that gives the user the
 * opportunity to define constraints that have to be fulfilled to obtain a
 * feasible solution.
 * </p>
 * <p>
 * As an example for the
 * <em>SAT Decoding</em> we will use the following example: Given
 * is a vector with a fixed number of binary (0/1) variables. The objective is
 * to minimize the number of 1s of this vector. The solution of this problem is
 * quite simple: Set all variables to 0. However, in order to make this problem
 * more difficult, we introduce the following condition: A solution is only
 * considered feasible if the variables satisfy a set of
 ...
 * <h2>Example</h2> 
 * <p>
 * In the following, an example that minimizes the ones of a
 * random is outlined. First, the {@link org.opt4j.core.Phenotype} and {@link org.opt4j.core.problem.Evaluator} are
 * defined.
 * 
 * <pre>
