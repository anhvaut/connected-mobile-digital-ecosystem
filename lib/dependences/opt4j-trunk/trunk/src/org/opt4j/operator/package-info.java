 ...
 * operators, e.g., a new {@link org.opt4j.operator.crossover.Crossover}
 * operator for the {@link org.opt4j.genotype.DoubleGenotype}, is quite simple.
 * The new operator has to be extended from
 * {@link org.opt4j.operator.crossover.Crossover} with the parameter
 * {@link org.opt4j.genotype.DoubleGenotype} or alternatively directly from the
 ...
 * {@link org.opt4j.operator.OperatorModule#configure(com.google.inject.Binder)}
 * method by
 ...
 * {@link org.opt4j.operator.OperatorModule}. Note that this operator will only
 * handle exactly its target {@link org.opt4j.core.Genotype} classes. To
 * indicate a specific target, use the {@link org.opt4j.operator.Apply}
 ...
 * </ul>
 * In the following, a custom {@link org.opt4j.operator.crossover.Crossover}
 * operator for the {@link org.opt4j.genotype.BooleanGenotype} shall be
 ...
 * {@link org.opt4j.operator.crossover.CrossoverModule} and add your custom
 * operator.
 * 
 * <pre>
