...
public class LoggerModule extends VisualizationModule {
	...
	@Info("Print also infeasible individuals as <it>INFEASIBLE</it>.")
	@Required(property = "loggingPerIteration", elements = { "TRUE" })
	@Constant(value = "printInfeasible", namespace = TsvLogger.class)
	protected boolean printInfeasible = false;
	...
	/**
	 * Returns {@code true} if the logger should print out also infeasible individuals.
	 * 
	 * @return {@code false} to omit infeasible individuals.
	 */
	public boolean isPrintInfeasible() {
		return printInfeasible;
	}
	 ...
	 */
	public void setPrintInfeasible(boolean printInfeasible) {
